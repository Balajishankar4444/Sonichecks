...
console.log('Connecting to Firebase Admin projectId:', projectId);
...
async function main() {
  try {
    ...
    await userRef.set(userData); // Replaces document without stacking
    console.log('✅ Successfully updated Firestore document in sonichecks-f7e58!');
