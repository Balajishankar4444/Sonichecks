...
import { Mail, MessageSquare, Send, CheckCircle2, ShieldCheck, Sparkles, AlertCircle, Loader2 } from 'lucide-react';
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage(err.message || 'Unable to submit your inquiry at this moment.');
    } finally {
              ...
              {submitted ? (
                <div className="py-12 text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-400 max-w-md mx-auto">
                      Your inquiry has been received. Our team will get back to you at <span className="text-cyan-300 font-mono">{formData.email}</span> shortly.
                    </p>
                  </div>
                  <button
                    type="button"
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold text-slate-300 bg-slate-800 hover:bg-slate-700 transition-colors cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full py-3 px-6 rounded-xl font-bold text-xs text-slate-950 bg-gradient-to-r from-cyan-400 to-blue-400 hover:from-cyan-300 hover:to-blue-300 shadow-md shadow-cyan-500/20 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <>
